...
<div class="bg-white shadow rounded-lg">
    ...
    <div class="p-6">
        ...
        <form method="POST" action="/admin/content/store" enctype="multipart/form-data" id="contentForm">
            ...
            <input type="hidden" name="master_content_uuid" id="master_content_uuid" value="">
            ...
            <div class="flex items-center justify-end pt-6 border-t border-gray-200 space-x-3">
                ...
                <button type="submit" name="action" value="draft" class="inline-flex items-center px-5 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-150 ease-in-out shadow-sm">
