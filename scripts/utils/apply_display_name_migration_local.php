<?php
/**
 * Apply display_name migration to the LOCAL database
 * Run this script to add the display_name field to the users table
 */

try {
    echo "Applying display_name migration to LOCAL database...\n";
    
    // Local database connection
    $dsn = 'mysql:host=localhost;dbname=cms_db;charset=utf8mb4';
    $db = new PDO($dsn, 'cms_user', 'cms_password');
