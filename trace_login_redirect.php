<?php
// Trace the exact redirect happening on login page
echo "=== TRACING LOGIN PAGE REDIRECT ===\n\n";
...
file_put_contents('trace_login.php', $traceScript);

// Push to GitHub
exec('git add trace_login.php && git commit -m "Add login redirect tracer" && git push origin main 2>&1', $output);
echo "1. Created and pushed trace script\n";
...
// Run trace
echo "\n3. Running trace...\n";
$response = @file_get_contents('https://dalthaus.net/trace_login.php');
if ($response) {
    echo $response;
}

echo "\n4. Testing with curl to see actual redirect...\n";
$ch = curl_init();
